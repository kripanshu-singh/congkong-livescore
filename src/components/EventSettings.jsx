  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar pb-20">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section>
          <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-4">{t.banner_upload}</h3>
            ...
            <div className="flex flex-col items-center justify-center gap-4">
              {localSettings.bannerUrl ? (
                <div className="relative w-full h-64 rounded-xl overflow-hidden border border-slate-200 shadow-sm group">
                  <img src={localSettings.bannerUrl} alt="Event Banner" className="w-full h-full object-cover" />
        ...
        <section>
          <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-4">{t.timer_settings}</h3>
          <GlassCard className="p-6 border-slate-200">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => handleChange('timerQnA', parseInt(e.target.value) || 0)}
                  className="w-full p-3 rounded-xl border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono font-bold text-lg"
                />
              </div>
            </div>
        ...
        <section>
          <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-4">{t.detail_info}</h3>
